...
from projects.simple_quiz.simple_quiz import get_cwd_path, read_quiz_data, get_user_answer, play_quiz, parse_arguments
from projects.simple_quiz.simple_quiz import QuizFileNotFoundError, InvalidJsonError
...
@pytest.mark.parametrize('user_answer_letter, expected', [
    ('a', 'option a'),
    ('z', None),
    ('abc', None),
])
