...
from projects.general.lyrics_cli.lyrics_cli import LyricsApp, parse_arguments


@pytest.mark.parametrize("artist, title", [("Nemo", "The Code"), ("JJ", "Wasted Love")])
...
def test_get_lyrics_not_found(capsys, monkeypatch):
    ...
    monkeypatch.setattr(LyricsApp, "_LyricsApp__fetch_lyrics", mock_lyrics_not_found)
