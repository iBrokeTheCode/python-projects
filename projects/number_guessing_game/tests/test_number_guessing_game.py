...
from projects.number_guessing_game.number_guessing_game import Colors, NumberOutOfRangeError, NumberGuessingGame
...
@pytest.mark.parametrize('guess, expected, message', [
