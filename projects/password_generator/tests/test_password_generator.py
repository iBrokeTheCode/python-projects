...
from projects.password_generator.password_generator import parse_arguments, generate_password, main


@pytest.mark.parametrize('args, expected', [
    (['password_generator.py'], [None, False, False, False, False]),
    (['password_generator.py', '--length', '12', '--uppercase',
     '--lowercase', '--digits', '--symbols'], (12, True, True, True, True)),
...
@pytest.mark.parametrize('params, expected_patterns', [
